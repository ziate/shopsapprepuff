                        ...
                        children: [
                          Container(
                            ...
                            child: Row(children: [
                              ...
                              InkWell(
                                onTap: () {
                                  if (authController.profileModel.bankName !=
                                      null) {
                                    Get.bottomSheet(
                          ...
                          Row(children: [
                            ...
                            WalletWidget(
                                title: 'withdrawn'.tr,
                                value: bankController.withdrawn),
                          ]),
                          ...
                          Row(children: [
                            ...
                            WalletWidget(
                                ...
                                value:
                                    authController.profileModel.totalEarning),
                          ]),
                          SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                          Row(
                              ...
                              children: [
                                ...
                                InkWell(
                                  onTap: () => Get.toNamed(
                                      RouteHelper.getWithdrawHistoryRoute()),
                                  child: Padding(
                          ...
                          SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                          bankController.withdrawList.length > 0
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    return WithdrawWidget(
                                      withdrawModel:
                                          bankController.withdrawList[index],
                                      showDivider: index !=
                                          (bankController.withdrawList.length >
                                                  10
                                              ? 9
