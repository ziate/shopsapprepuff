          ...
          Expanded(
            ...
            child:
                ...
                Expanded(
                    child: Column(
                      ...
                      Row(children: [
                        Expanded(
                            child: Text(
                          '${'discount'.tr}: ${product.discount} ${product.discountType == 'percent' ? '%' : Get.find<SplashController>().configModel.currencySymbol}',
                          maxLines: 1,
                          overflow: TextOverflow.ellipsis,
                          style: robotoRegular,
                        )),
              ...
              product.variations.length > 0
                  ...
                  : SizedBox(),
              SizedBox(
                  height: product.variations.length > 0
                      ? Dimensions.PADDING_SIZE_EXTRA_SMALL
                      : 0),
              product.variations.length > 0
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Row(children: [
                          Text(product.variations[index].type + ':',
                              style: robotoRegular.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_SMALL)),
                          SizedBox(width: Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          Text(
              ...
              product.addOns.length > 0
                  ...
                  : SizedBox(),
              SizedBox(
                  height: product.addOns.length > 0
                      ? Dimensions.PADDING_SIZE_EXTRA_SMALL
                      : 0),
              product.addOns.length > 0
                  ? ListView.builder(
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        restController.productReviewList != null
                            ? restController.productReviewList.length > 0
                                ? ListView.builder(
                                    itemCount:
                                        restController.productReviewList.length,
                                    physics: NeverScrollableScrollPhysics(),
                                    shrinkWrap: true,
                                    itemBuilder: (context, index) {
                                      return ReviewWidget(
