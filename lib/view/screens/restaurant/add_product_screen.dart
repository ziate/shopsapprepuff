                ...
                Expanded(
                  ...
                  child: Column(
                      ...
                      children: [
                              ...
                              child: Column(
                                ...
                                Container(
                                  ...
                                  child: DropdownButton<String>(
                                    value: restController.discountTypeIndex == 0
                                        ? 'percent'
                                        : 'amount',
                                  ...
                                  child: DropdownButton<int>(
                                    ...
                                    items: restController.subCategoryIds
                                      ...
                                      return DropdownMenuItem<int>(
                                        ...
                                        child: Text(value != 0
                                            ? restController
                                                .subCategoryList[(restController
                                                        .subCategoryIds
                                                        .indexOf(value) -
                                                    1)]
                                                .name
                          ...
                          return Autocomplete<int>(
                            optionsBuilder: (TextEditingValue value) {
                              if (value.text.isEmpty) {
                                ...
                                return _addons.where((addon) => addonController
                        ...
                        SizedBox(
                            height: restController.selectedAddons.length > 0
                                ? Dimensions.PADDING_SIZE_SMALL
                                : 0),
                        SizedBox(
                          height:
                              restController.selectedAddons.length > 0 ? 40 : 0,
                              ...
                              ClipRRect(
                                ...
                                child: restController.pickedLogo != null
                                    ...
                                    : FadeInImage.assetNetwork(
                                        ...
                                        image:
                                            '${Get.find<SplashController>().configModel.baseUrls.productImageUrl}/${_product.image != null ? _product.image : ''}',
                                        height: 120,
                                        width: 150,
                                        fit: BoxFit.cover,
